...
![](img/iceberg-settings-button.png)
...
![](img/new-branch-for-issue-window.png)
...
![](img/new-branch-for-issue-number.png)
...
![](img/repo-with-uncommitted-changes.png)
