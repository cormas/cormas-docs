...
By default, the parameter ***r*** (reproduction rate) is fixed to 0.2 (/step) and the parameter ***K*** (carrying capacity) is fixed to 10 (units of biomass).
...
In UML, the underlined attributes are called “Class variables”: their values are equal for all instances.
