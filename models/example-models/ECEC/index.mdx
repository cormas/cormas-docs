...
![Logistic growth equation](./img/logistic.png){width=700}
...
![Forager movement](./img/foragerMove.png){width=130}
...
![Forager reproduction](./img/foragerReproduction.png){width=130}

### UML description of ECEC

The following Class diagram presents the structure of the model:

![ECEC Class Diagram](./img/ececClassDiag.png){width=700}
...
![Initial grid](./img/initialGrid.png){width=700}
...
![ECEC Probes](./img/ececProbes.png){width=700}
...
![ECEC 100 repetitions](./img/ecec1000rep.png){width=500}
...
![Predator and Prey evolution](./img/predatorPreys.png){width=700}
...
![ECEC Plants and Foragers Evolution](./img/ececPlantsForagersEvolution.png){width=500}
...
![ECEC Oasis](./img/ececOasis.png){width=500}
