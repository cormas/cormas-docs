...
const config = {
  title: 'Cormas',
  tagline: 'Particpatory Modelling Platform',
  ...
  organizationName: 'cormas', // Usually your GitHub org/user name.
  projectName: 'cormas-docs', // Usually your repo name.
  trailingSlash: false,
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://vw.cormas.org/indexeng.htm',
            label: 'Cormas VW',
            position: 'right',
          }
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Cormas`,
      },
      prism: {
